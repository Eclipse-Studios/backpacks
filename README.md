...
*^ only needed if playing on Fabric or Quilt*
...
- Brazilian Portuguese (pt_br): By [alexsanderfer](https://github.com/alexsanderfer) and [MeiaQuatru](https://github.com/MeiaQuatru).
- Simplified Chinese (zh_cn): By [calmastorm](https://github.com/calmastorm).
- Russian (ru_ru): By [Akrek](https://github.com/Akrek).
- European Portuguese (pt_pt): By [AlexandreC2000](https://github.com/AlexandreC2000).

You can contribute to this project by translating to other languages! See how [here](https://github.com/Eclipse-Studios/backpacks/wiki/%F0%9F%8C%90-Supported-Languages).
