...
tellraw @a [{"text":"[BP] ","color":"yellow"},{"text":"Backpacks!","underlined":true,"color":"gold","click_event":{"action":"open_url","url":"https://modrinth.com/datapack/vanilla-backpacks"}}," ",{"text":"(v1.3.2)","underlined":true,"color":"green","click_event":{"action":"open_url","url":"https://modrinth.com/datapack/vanilla-backpacks/changelog"},"hover_event":{"action":"show_text","value":[{"translate":"load.backpacks.message.5"}]}},{"text":" - ","color":"gray"},{"translate":"load.backpacks.message.4","color":"blue"},{"text":"☽ Eclipse Studios","underlined":true,"color":"blue","click_event":{"action":"open_url","url":"https://www.youtube.com/@EclipseStudiosMC"}}]
